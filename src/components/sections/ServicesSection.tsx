    ...
    <section id="services" className="py-12 md:py-20 bg-background">
      <div className="container">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-headline text-primary">Our Services</h2>
          <p className="mt-2 text-lg text-muted-foreground">Quality care for your hair</p>
        </div>
